...
class Hmm(object):
    ...
    # edited read_counts to keep track of infrequent words (count < 5) and word counts for each word
    # Returns all count dictionaries/sets
    def read_counts(self, corpusfile):
        ...
        for word, count in self.word_counts.iteritems():
            if count < 5:
                self.infrequent_words.add(word)

        return (self.emission_counts, self.ngram_counts, self.infrequent_words, self.all_states, self.word_counts)
